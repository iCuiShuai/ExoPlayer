...
public final class MXDownloadHelper {
  ...
  /** A callback to be notified when the {@link MXDownloadHelper} is prepared. */
  public interface Callback {

    /**
     * Called when preparation completes.
     *
     * @param helper The reporting {@link MXDownloadHelper}.
     */
    void onPrepared(MXDownloadHelper helper);
     ...
     * @param e The error.
     */
    void onPrepareError(MXDownloadHelper helper, IOException e);
  }
...
//    trackSelector.init(/* listener= */ () -> {}, new DummyBandwidthMeter());
  ...
  private static final class MediaPreparer
    ...
    private final MXDownloadHelper downloadHelper;
    ...
    public MediaPreparer(MediaSource mediaSource, MXDownloadHelper downloadHelper) {
      this.mediaSource = mediaSource;
...
//      Handler downloadThreadHandler = Util.createHandler(this::handleDownloadHelperCallbackMessage);
      this.downloadHelperHandler = new Handler(Looper.getMainLooper()) {
        ...
        public void handleMessage(@NonNull Message msg) {
          handleDownloadHelperCallbackMessage(msg);
