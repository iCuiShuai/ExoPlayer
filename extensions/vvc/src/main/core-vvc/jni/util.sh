...
get_release_dir()
{
    ...
    case $1 in
    neon)
        release_dir=../../jniLibs/armeabi-v7a
    ;;
    tegra3)
        release_dir=../../jniLibs/armeabi
    ;;
    tegra2)
        release_dir=../../jniLibs/armeabi
    ;;
    arm64)
        release_dir=../../jniLibs/arm64-v8a
    ;;
    x86_64)
        release_dir=../../jniLibs/x86_64
    ;;
    x86)
        release_dir=../../jniLibs/x86
    ;;
    *)
        die "Unsupported architecture"
    esac
...
get_nocodec_dir()
{
    ...
    case $1 in
    neon)
        nocodec_dir=../../mxcore_release/libs.no_codec/armeabi-v7a
    ;;
    tegra3)
        nocodec_dir=../../mxcore_release/libs.no_codec/armeabi-v7a
    ;;
...
copy_target(){
    ...
    cp ${dst_dir}/lib${2}.so ${release_dir}
}

copy_loader(){
    dst_dir=$(get_dst_dir ${1})
    nocodec_dir=$(get_nocodec_dir ${1})
    cp ${dst_dir}/libloader.mx.so ${nocodec_dir}
}