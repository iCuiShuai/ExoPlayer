...
class OmaUtil {
    ...
    interface OmaFactory {
        /** Creates [OmSdkSettings] for configuring the IMA SDK.  */
        fun createImaSdkSettings(): OmSdkSettings?
        ...
        fun createAdsLoader(
                context: Context?, imaSdkSettings: OmSdkSettings?, adDisplayContainer: AdDisplayContainer?, configuration: Configuration): AdsLoader?
    }
